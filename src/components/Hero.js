  ...
  return (
    <>
      <div className="hero" id="hero">
        ...
        <div className="w-full h-160 flex items-center justify-center text-white cta">
          <div className="mx-10 w-full h-96 text-center lg:text-left py-16 px-12 flex lg:justify-between items-center">
            <div className="w-full flex flex-col lg:flex-row lg:justify-around">
              <div className="mb-4">
                <p className="text-2xl md:text-4xl font-bold mb-4">
                  Empowering and inspiring organisations with innovative
